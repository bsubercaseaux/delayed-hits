...
def total_penalty(N_tests, N_pages, k, sequence_length):
    ...
    for idx, algo in enumerate(algos):
        ...
        m, lm, hm = mean_confidence_interval([data[0] for data in data_algo])
        Y.append(m)
        lower.append(lm)
        upper.append(hm)
    ...
    for Z in Z_RANGE:
        ...
        Y_2.append(alg_data[0] )
        Y_3.append(alg_data_2[0] )
        Y_4.append(alg_data_3[0] )
    ...
    ax.set(xlabel="Z", ylabel="Total Penalty")
...
total_penalty(N_tests, N_pages, k, sequence_length)
